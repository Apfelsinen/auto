...
function auto_scripts() {
	wp_enqueue_style( 'auto-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'auto-style', 'rtl', 'replace' );

	wp_enqueue_script( 'auto-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
